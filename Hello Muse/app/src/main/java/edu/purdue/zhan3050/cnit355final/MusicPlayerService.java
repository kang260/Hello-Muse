...
public class MusicPlayerService extends Service {
    ...
    public void onCreate() {
        ...
        intentNext.setAction("MUSIC_SWITCH");
        ...
        intentPre.setAction("MUSIC_SWITCH");
...
//        notification2 = mBuilder.build();
        ...
        IntentFilter filter = new IntentFilter("MUSICPLAY_BROADCAST");
...
//        mBuilder.setContent(remoteViews)l
//        notification2 = mBuilder.build();
     ...
     * set MusicInfo List
     */
    public void setMusicInfoList(List<MusicInfo> musicInfoList1) {
        musicInfoList = musicInfoList1;
    }
    ...
    public void setMediaPlayer(MediaPlayer mediaPlayer1) {
        ...
        if (mediaPlayer == null) {
            ...
            intent1.setAction("MUSIC_BROADCAST");
